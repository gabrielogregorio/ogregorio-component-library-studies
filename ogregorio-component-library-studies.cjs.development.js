...
})(exports.TextVariantEnum || (exports.TextVariantEnum = {}));
const Text = ({
  children,
  variant = exports.TextVariantEnum.default,
  isActive = false,
  isDone = false
}) => {
...
const Breadcrumb = ({
  ...
  }, React__default.createElement(ButtonWithSound, {
    onClick: () => onReturns(),
    variant: exports.TextVariantEnum.titleBreacrumb,
    content: "INICIO"
...
exports.ButtonWithSound = ButtonWithSound;
exports.NavigationLevel = NavigationLevel;
exports.NavigationSpace = NavigationSpace;
exports.Text = Text;
