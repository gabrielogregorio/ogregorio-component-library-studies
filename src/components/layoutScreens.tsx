...
const Breadcrumb = ({ screenTitle, onReturn }: BreadcrumbProps) => {
  return (
    <div className="flex justify-center items-center w-full">
      ...
      <p className="ml-[1rem] text-white text-[28px] tracking-[10%] font-normal whitespace-nowrap">{screenTitle}</p>
...
export const LayoutScreen = ({ children, bg, screenTitle, onReturn }: LayoutScreenProps) => {
  return (
